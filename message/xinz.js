/*
	...
	ðŸ”• KLO MAU RE UPLOAD IZIN DULU, BACA DESK VIDEO
...
var waktoo = date.getHours();
		...
		switch(bulan1) {
			...
			if(time2 < "23:59:00"){
				var ucapannya = `Night ðŸŒš ${pushname}`
				}
       	 if(time2 < "19:00:00"){
     		   var ucapannya = `Night ðŸŒš ${pushname}`
				}
     	   if(time2 < "18:00:00"){
     		   var ucapannya = `Afternoon ðŸŒ… ${pushname}`
				}
      	  if(time2 < "15:00:00"){
     		   var ucapannya = `GoodDay ðŸŒž ${pushname}`
				}
    	    if(time2 < "11:00:00"){
       		 var ucapannya = `Morning ðŸŒ„ ${pushname}`
				}
    	    if(time2 < "05:00:00"){
  		      var ucapannya = `Night ðŸŒš ${pushname}`
				}
...
Minat? Pm wa.me/${owner_number}`,
	    ...
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`,jpegThumbnail: thumbnail}}}
        const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} } 
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, 'jpegThumbnail': thumbnail}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, 'jpegThumbnail': thumbnail}}}
		const fgclink2 = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, 'jpegThumbnail': thumbnail}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, "h": `Hmm`,'seconds': '99999', 'caption': `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, 'jpegThumbnail': thumbnail}}}
		...
		const fkontak = {key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {contactMessage: {displayName: `ã€Œ ð‘ð”ðð“ðˆðŒð„ ã€\n${runtime2}`, vcard: 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'N:Bot;Lord;Userbot;;\n' + 'FN: SUBSCRIBE YT ZEEONE OFC\n' + 'item1.TEL;waid=62887435047326:+62887435047326\n' + 'item1.X-ABLabel:Telepon\n' + 'END:VCARD'}}}
		const isUrl = (url) => {
				...
				Zeeone.sendMessage(from, hasil, type, options).catch(e => {
					...
					if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
						if (budy.match(/(https:\/\/chat.whatsapp.com)/gi)) {
							...
							buttonText: {
								displayText: `ðŸ”– DISABLE ANTILINK`,
								},
								type: 1,
								}]);
					...
					if (budy.length > 10000) {
						...
						Zeeone.sendMessage(from, `ã€Œ *VIRTEX DETECTED* ã€ `, text, {quoted: Ofc})
						Zeeone.sendMessage(from, '*TANDAI TELAH DI BACA!!*\n'.repeat(300), text)
					}
							...
							if (chats.toLowerCase().includes(kasar)){
								if (isCountKasar(sender, senbadword)){
									...
									sendButMessage(from, `*ANTI BADWORD*\n\nHai ${pushname}\nSepertinya kamu sudah berkata kasar lebih dari 2x, maaf kamu akan di kick`, `Klik Di Bawah Untuk Mematikan`, [
									{
										...
										buttonText: {
											displayText: `ðŸ”– DISABLE ANTI BADWORD`,
											},
											type: 1,
											}]);
									Zeeone.groupRemove(from, [sender])
						...
						switch (command) {
										...
										if ((args[0]) == 'ori'){
											...
											reply(`_Succses mengganti menu ke menu ori_`)
												...
												reply(`_Succses mengganti menu ke menu simple_`)
													...
													reply(`*Example :*${enter} â€¢${prefix + command} simple\n  for simple menu\n${enter} â€¢${prefix + command} ori\n  for real menu`)
												}
										break
							case 'verify': case 'daftar':
										...
										let papako = [{
											...
											sendButLocation(from, teks , `Thank for verification ðŸ’‹\n${namabot}â„¢Â© | By ${owner_name}`, thumbnail, papako, {contextInfo: { mentionedJid: [sender]}})
									break
...
ðŸ†” *Pengirim :* @${sender.split("@")[0]}
ðŸ“› *Penerima :* ${tujuan}
ðŸ’¹ *Jumlah Limit :* ${jumblah}
...
*ðŸ“Š Sisa Balance : ${getBalance(sender, balance)}*
...
ðŸ†” *Nama* : ${i.name}
ðŸŽ¯ *Link* : ${i.link}\n
ðŸ‘¨â€ðŸ’» *Dev* : ${i.developer}
ðŸŒ *Link Dev* : ${i.link_dev}
`
}
									reply(store)
									break
						case 'brainly':
									...
									brainly(`${q}`).then(res => {
										...
										for (let Y of res.data) {
											teks += `ðŸ”– *PERTANYAAN :* ${Y.pertanyaan}\nðŸ’¬ *JAWABAN :* ${Y.jawaban[0].text}\n\n`
											}
...
_Tunggu Proses Upload Media_`
						...
						case 'yts': case 'youtubesearch': case 'ytsearch':{
									...
									.then((res) => {
										...
										l = 1
										for (let i = 0; i < 15; i++){
											txt += `\n${l++}.ðŸ“› *Judul :* ${yt[i].title}\nðŸ†” *Id :* ${yt[i].videoId}\nðŸ’¢ *Upload :* ${yt[i].ago}\nðŸ‘ï¸â€ðŸ—¨ï¸ *Ditonton :* ${yt[i].views}\nðŸ’¢ *Duration :* ${yt[i].timestamp}\nðŸ”— *Url :* ${yt[i].url}\n___________________\n`
											}
...
Alasan : ${reason}`, [sender], true)
						...
						case 'setppbot':
									...
									reply('Makasih pp barunya lord ðŸŒ')
									break
						case 'setppgrup':
									if (!isGroup) return reply(mess.only.group)
									if (!isGroupAdmins && !isOwner) return reply(mess.only.admin)
						...
						case 'cekprem': case 'cekpremium': case 'premiumcek':
									...
									let premiumnya = `*ã€Œ PREMIUM EXPIRE ã€*\n\nðŸ†” *ID*: ${sender}\nâ° *Expired*: ${cekExp.days} day(s) ${cekExp.hours} hour(s) ${cekExp.minutes} minute(s)`
									reply(`${isOwner?'Unlimited Prem (My Lord)':premiumnya}`)
									break
						
						case 'listprem': case 'listpremium': case 'premiumlist': case 'premlist':
									if (!isOwner && !Ofc.key.fromMe) return
									let txt = `*ã€Œ LIST PREMIUM ã€*\n\n*ðŸ’¹ Total :* ${_premium.length}\n\n`
									let men = [];
									for (let i of _premium){
										men.push(i.id)
										let cekvip = ms(i.expired - Date.now())
										txt += `*ðŸ†” Nomor : ${i.id.split("@")[0]}*\n*ðŸ“› User : @${i.id.split("@")[0]}*\nðŸ“Š Expired : ${cekvip.days} Day (s), ${cekvip.hours} Hour (s), ${cekvip.minutes} Minute (s), ${cekvip.seconds} Second (s)`
									}
									reply(`${txt}`)
									break
						...
						case 'sewalist':  case 'listsewa':
									...
									for (let i of sewa){
										...
										txtnyee += `ðŸ†” *ID :* ${i.id}\nðŸ“Š *Expire :* ${cekviopp.days} day(s) ${cekviopp.hours} hour(s) ${cekviopp.minutes} minute(s) ${cekviopp.seconds} second(s)\n\n`
										}
										reply(txtnyee)
									break
...
ðŸ†” *ID*: ${from}
ðŸ’¹ *EXPIRE :* ${cekvip.days} day(s) ${cekvip.hours} hour(s) ${cekvip.minutes} minute(s)`
									reply(sewenye)
									break
...
ðŸ“› Nama : ${pushname==undefined?sender.split("@")[0]:pushname}
ðŸŽ¯ Bio : ${p.status==undefined?`Not Found`:p.status}
ðŸ’¬ Tag : @${sender.split("@")[0]}
ðŸ†” Api : wa.me/${sender.split("@")[0]}

â¬£ Limit : ${isPremium ? 'Unlimited Premium' : `${getLimit(sender, limitawal, limit)} / ${limitawal}`}
...
â¬£ Baned : ${isBanned?`Terbanned`:`Tidak Terbanned`}`, quoted: Ofc, contextInfo:{mentionedJid:[sender]}})
									}
									break
...
ðŸ“› Nama : ${groupName}
ðŸ‘¤ Owner Grup : ${groupMetadata.owner}
ðŸ‘¥ Total Member : ${groupMembers.length}
ðŸ‘¥ Total Admin : ${groupAdmins.length}
 
â¬£ Welcome : ${isWelkom ? 'On':'Off'}
â¬£ Anti Link : ${isAntiLink? 'On':'Off'}
â¬£ Anti Badword : ${isBadword? 'On':'Off'}
â¬£ Anti Fake Troli : ${isAntro? 'On':'Off'} ${isSewa?`
â¬£ Expired Sewa : ${cekviip.days} Hari, ${cekviip.hours} Jam, ${cekviip.minutes} Menit, ${cekviip.seconds} Detik*`:``}
...
\`\`\`${groupDesc}\`\`\``
						...
						case 'toimg': 
									...
									if ((isMedia && !Ofc.message.videoMessage || isQuotedImage || isQuotedSticker && args.length == 0)) {
										...
										exec(`ffmpeg -i ${media} ${ran}`, (err) => {
											fs.unlinkSync(media)
											if (err) return reply('âŽ Gagal, pada saat mengkonversi sticker ke gambar âŽ')
											buffer = fs.readFileSync(ran)
...
*ðŸ”– Url : ${vrr.display_url}*`
						...
						case 'truth':
									...
									break
						case 'slot':
									const sotoy = ['ðŸŠ : ðŸ’ : ðŸ','ðŸ’ : ðŸ : ðŸŠ','ðŸ : ðŸ’ : ðŸ','ðŸŠ : ðŸ‹ : ðŸ””','ðŸ”” : ðŸ’ : ðŸ','ðŸ”” : ðŸ’ : ðŸŠ','ðŸŠ : ðŸ‹ : ðŸ””','ðŸ : ðŸ’ : ðŸ‹','ðŸ : ðŸ : ðŸ','ðŸŠ : ðŸ’ : ðŸ’','ðŸ”” : ðŸ”” : ðŸ‡ ','ðŸŒ : ðŸ’ : ðŸ””','ðŸ : ðŸ”” :  ðŸ””','ðŸŠ : ðŸ‹ :  ðŸ’','ðŸ‹ : ðŸ‹ :  ðŸŒ','?? : ðŸ”” : ðŸ‡','ðŸ”” : ðŸ :  ðŸ‡','ðŸ”” : ðŸ”” :  ðŸ””','ðŸ’ : ðŸ’ :  ðŸ’','ðŸŒ : ðŸŒ : ðŸŒ','ðŸ‡ : ?? : ðŸ‡']
							...
							for (let i of ownerContact.map(v => v + '@s.whatsapp.net')) {
								...
								ini_list.push({
									...
									hehe = await Zeeone.sendMessage(from, {
										...
										Zeeone.sendMessage(from, `Nih Kak Contact Owner Ku âœ¨`, text, {quoted: hehe})
										}
										break
						case 'lirik':
									...
									try {
										...
										for (let mem of totalchat){
											...
											for (let id of i){
												...
												teks = `ã€Œ *BOT STATISTIC* ã€ 

ðŸ”– Botname : ${namabot}
ðŸ”– Owner : @${nupe.split("@")[0]}
ðŸ”– Prefix : ${nopref?'No prefix':multiprefix?'Multi prefix':prefix}
ðŸ”– Runtime : ${kyun(process.uptime())}
ðŸ”– Speed : ${processsTime(Ofc.messageTimestamp.low, moment())}s
ðŸ”– Status : ${public_mode? `Public Mode`:`Self Mode`}
ðŸ”– Total Hit : -
ðŸ”– Personal Chat : ${totalchat.length - giid.length}
ðŸ”– Group Chat : ${giid.length}
ðŸ”– Total Chat : ${totalchat.length}
ðŸ”– Total User : ${_user.length}
ðŸ”– Total Block : ${blocked.length}
ðŸ”– Total Baned : ${ban.length}

ðŸ·ï¸ Anti Call : ${setting.anti_call}
ðŸ·ï¸ Anti Delete : ${setting.anti_delete}
ðŸ·ï¸ Auto Register : ${autoregister}
ðŸ·ï¸ Auto Respond : ${autorespon? `False` : `True`}
ðŸ·ï¸ Multi Prefix : ${multiprefix}
ðŸ·ï¸ Anti Delete : ${menusimple? `False` : `True`}

ã€Œ *PHONE STATISTIC* ã€
 
ðŸ”– Whatsapp Ver. : ${wa_version}
ðŸ”– Ram Usage : ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB
ðŸ”– Mcc : ${mcc}
ðŸ”– Mnc : ${mnc}
ðŸ”– Versi OS : ${os_version}
ðŸ”– Merk HP : ${device_manufacturer}
ðŸ”– Versi HP : ${device_model}
ðŸ”– Browser : ${Zeeone.browserDescription}
ðŸ”– Baterai : ${isBattre} %
ðŸ”– Charging : ${isCharge}
`
let qqppp = [{
                ...
                sendButLocation(from, teks, `LordUserbotâ„¢Â© | Allright Reserved.`, thumbnail, qqppp, {contextInfo: { mentionedJid: [nupe]}})
...
break
						...
						case 'nuliskiri':{
									...
									.on('exit', () => {
										Zeeone.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: Ofc, caption: `Jangan Malas Lord. Jadilah siswa yang rajin à²°_à²°`})
										limitAdd(sender, limit)
										})
									}
									break
						case 'nuliskanan':{
									...
									.on('error', () => reply(mess.error))
									.on('exit', () => {
										Zeeone.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: Ofc, caption: `Jangan Malas Lord. Jadilah siswa yang rajin à²°_à²°`})
										limitAdd(sender, limit)
										})
									}
									break
						case 'foliokiri':{
									...
									.on('error', () => reply(mess.error))
									.on('exit', () => {
										Zeeone.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: Ofc, caption: `Jangan Malas Lord. Jadilah siswa yang rajin à²°_à²°`})
										limitAdd(sender, limit)
										})
									}
									break
						case 'foliokanan':{
									...
									.on('error', () => reply(mess.error))
									.on('exit', () => {
										Zeeone.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: Ofc, caption: `Jangan Malas Lord. Jadilah siswa yang rajin à²°_à²°`})
										limitAdd(sender, limit)
									})
									}
									break
						...
						case 'listimage': case 'listphoto': case 'listfoto': 
									let listimage = '*ã€Œ LIST STICKER ã€*\n\n'
									for (let awokwkwk of imagenye) {
										listimage += `ðŸ“Š ${awokwkwk}\n`
										}
						...
						case 'listvideo': case 'listvid':  
									let listvideo = '*ã€Œ LIST VIDEO ã€*\n\n'
									for (let awokwkwk of videonye) {
										listvideo += `ðŸ“Š ${awokwkwk}\n`
										}
						...
						case 'liststik': case 'liststicker': case 'liststiker': case 'liststick':
									liststik = '*ã€Œ LIST STICKER ã€*\n\n'
									for (let awokwkwk of setiker) {
										liststik += `ðŸ“Š ${awokwkwk}\n`
										}
									...
									function toTime(UNIXtimestamp, ribuan) {
										...
										function toBulan(UNIXtimestamp, ribuan) {
											...
											if (ribuan) {
												...
												for (let i of hemm) {
													teksx += `ðŸ“› Nama : @${i.jid.split('@')[0]}\nâ° Waktu : ${toTime(i.t, true)}\nðŸ“… Tanggal : ${toBulan(i.t, true)}\n\n`
													}
												teksx1 = `ã€Œ *BELUM DIBACA* ã€\n\n`
												for (let i of hemms) {
													teksx1 += `ðŸ“› Nama : @${i.jid.split('@')[0]}\n`
						...
						case 'inspect':
									...
									try {
										...
										expect200: true})
										caption = `ã€Œ *GROUP LINK INSPECTOR* ã€ 
										
ðŸ”– Nama Grup : ${res.subject}
ðŸ”– Terakhir di ubah oleh : @${res.subjectOwner.replace("@c.us","")}
ðŸ”– Di Ubah Pada ${formatDate(res.subjectTime * 1000)}

ðŸ”– ID : ${res.id}
ðŸ”– Di Buat Oleh : @${res.id.split('-')[0]}
ðŸ”– Di Buat pada ${formatDate(res.creation * 1000)}

ðŸ”–Edit info grup : ${res.restrict?`Hanya admin`:`Semua peserta`}
ðŸ”–Kirim pesan : ${res.announce?`Hanya admin`:`Semua peserta`}
ðŸ”–Pesan sementara : ${res.ephemeralDuration?`Aktif`:`mati`}
ðŸ”–Jumlah Member : ${res.size}
ðŸ”–Member Yang Diketahui : ${res.participants ? '\nâ”‚ *' + res.participants.map((user, i) => ++i + '. @' + user.id.split`@`[0]+'*').join('\nâ”‚ *').trim() : 'Gada'}
ðŸ”–Deskripsi :*
${res.desc ? `${res.desc}` : 'Gada'}
ðŸ”–Terakhir di ubah oleh : @${res.descOwner.replace("@c.us","")}*
ðŸ”–Di ubah pada ${formatDate(res.descTime * 1000)}`
									try {
...
let papako = [{
								...
								sendButLocation(from, teks , `Thank for verification ðŸ’‹\n${botname}â„¢Â© | By ${ownername}`, thumbnail, papako, {contextInfo: { mentionedJid: [sender]}})
                }
